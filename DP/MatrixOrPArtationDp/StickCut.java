...
public class StickCut {
    ...
    public static int minCostToCutStickTabu(int[] cuts, int n) { // tc O(n^3) sc O(n^2)
        ...
        for (int i = 0; i + len <= m + 1; i++) {
            int j = i + len; // last ind to cal cut
    ...
    public static void main(String[] args) {
       ...
       System.out.println("Minimum cost to cut the stick: " + minCostToCutStickTabu(arr, n));
    }
}
